...
class TwistedConsumer(BaseConsumer):
    def __init__(self, base_url, public_key, private_key):
        super(TwistedConsumer, self).__init__(base_url, public_key, private_key)
...
class ProviderResource(Resource):
    ...
    def render_POST(self, request):
        ...
        deferred = threads.deferToThread(self.provider.get_response, 'POST', signed_data, get_header)
